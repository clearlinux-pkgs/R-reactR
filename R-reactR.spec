...
Source0  : https://cran.r-project.org/src/contrib/reactR_0.6.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719420478
...
/usr/lib64/R/library/reactR/www/react-tools/react-tools.umd.cjs
